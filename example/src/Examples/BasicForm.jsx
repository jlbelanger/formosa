...
export default function BasicForm() {
	...
	const className = [];
	if (horizontal) {
		className.push('formosa-horizontal');
	}
	if (responsive) {
		className.push('formosa-responsive');
	}
	...
	return (
		<>
			...
			<button className="formosa-button" onClick={toggleResponsive} type="button">
				{responsive ? 'Disable Responsive' : 'Enable Responsive'}
			</button>

			<Form className={className.join(' ')} onSubmit={onSubmit} row={row} setRow={setRow}>
				<Field
					label="Text"
					name="text"
					type="text"
